...
const fakePromisify = Object.assign({}, pfy, {
    promisifyAll: (klass, options) => {
        ...
        promisified = true;
        assert.deepStrictEqual(options.exclude, ['publish', 'publishJSON', 'setPublishOptions', 'subscription']);
    },
});
class FakeIAM {
...
describe('Topic', () => {
    ...
    describe('setPublishOptions', () => {
        it('should call through to Publisher#setOptions', () => {
            const fakeOptions = {};
            const stub = sandbox.stub(topic.publisher, 'setOptions').withArgs(fakeOptions);
