...
class FakeConnection extends events_1.EventEmitter {
    constructor() {
        super();
...
describe('ConnectionPool', () => {
    ...
    describe('initialization', () => {
        ...
        it('should inherit from EventEmitter', () => {
            assert(pool instanceof events_1.EventEmitter);
        });
    ...
    describe('createMessage', () => {
        ...
        it('should capture the message data', () => {
            const expectedPublishTime = new Date(Math.floor(PT.seconds) * 1000 + Math.floor(PT.nanos) / 1e6);
